...
Namespace RSWINV3
	Public Class rptRecommendedGuideReport
		...
		Private Overridable Property lblGuideType As DataDynamics.ActiveReports.Label
			Get
				Return Me._lblGuideType
			End Get
			<MethodImpl(MethodImplOptions.Synchronized)>
			Set(value As DataDynamics.ActiveReports.Label)
				Me._lblGuideType = value
			End Set
		End Property
		...
		Private Sub InitializeComponent()
			Dim componentResourceManager As ComponentResourceManager = New ComponentResourceManager(GetType(rptRecommendedGuideReport))
			...
			Me.lblGuides = New DataDynamics.ActiveReports.Label()
			...
			Me.lblGuideType2 = New DataDynamics.ActiveReports.Label()
			...
			Me.lblGuideType = New DataDynamics.ActiveReports.Label()
			...
			CType(Me.lblGuides, ISupportInitialize).BeginInit()
			...
			CType(Me.lblGuideType, ISupportInitialize).BeginInit()
			...
			Me.fldFootnoteMarker.Top = 0F
			Me.fldFootnoteMarker.Width = 0.2589998F
			...
			Me.PageFooter.Height = 0.5000001F
			...
			Me.GroupHeader1.Controls.AddRange(New ARControl() { Me.lblGuides, Me.lblFromTo, Me.lblMaxSideLoadUnits, Me.lblDepth, Me.lblMaxSideLoad, Me.lblGuideType2, Me.lblGuideNumber, Me.Line1, Me.Line2, Me.Line3, Me.Line4, Me.lblRodDiameter, Me.Line5, Me.lblRodDiamUnits, Me.lblGuideType, Me.lblTaper, Me.lblTaperNumber, Me.Line6 })
			Me.GroupHeader1.Height = 0.4270832F
			Me.GroupHeader1.Name = "GroupHeader1"
			Me.GroupHeader1.RepeatStyle = RepeatStyle.OnPageIncludeNoDetail
			Me.lblGuides.Height = 0.18F
			Me.lblGuides.HyperLink = Nothing
			Me.lblGuides.Left = 6.59F
			Me.lblGuides.Name = "lblGuides"
			Me.lblGuides.Style = "background-color: rgb(192,192,192); color: rgb(255,255,255); text-align: center"
			Me.lblGuides.Text = "Number of Guides"
			Me.lblGuides.Top = 0.012F
			Me.lblGuides.Width = 1.285F
			Me.lblFromTo.Height = 0.1875F
			Me.lblFromTo.HyperLink = Nothing
			Me.lblFromTo.Left = 1.098F
			...
			Me.lblFromTo.Top = 0.1995F
			Me.lblFromTo.Width = 1.344F
			Me.lblMaxSideLoadUnits.Height = 0.1875F
			Me.lblMaxSideLoadUnits.HyperLink = Nothing
			Me.lblMaxSideLoadUnits.Left = 3.682F
			...
			Me.lblMaxSideLoadUnits.Top = 0.199F
			Me.lblMaxSideLoadUnits.Width = 1.708F
			Me.lblDepth.Height = 0.1875F
			Me.lblDepth.HyperLink = Nothing
			Me.lblDepth.Left = 1.098F
			...
			Me.lblDepth.Top = 0.0115F
			Me.lblDepth.Width = 1.344F
			Me.lblMaxSideLoad.Height = 0.1875F
			Me.lblMaxSideLoad.HyperLink = Nothing
			Me.lblMaxSideLoad.Left = 3.682F
			...
			Me.lblMaxSideLoad.Top = 0.0115F
			Me.lblMaxSideLoad.Width = 1.708F
			Me.lblGuideType2.Height = 0.1875F
			Me.lblGuideType2.HyperLink = Nothing
			Me.lblGuideType2.Left = 5.453001F
			Me.lblGuideType2.Name = "lblGuideType2"
			Me.lblGuideType2.Style = "background-color: rgb(192,192,192); color: rgb(255,255,255); text-align: center"
			Me.lblGuideType2.Text = ""
			Me.lblGuideType2.Top = 0.1995F
			Me.lblGuideType2.Width = 1.082F
			Me.lblGuideNumber.Height = 0.1875F
			Me.lblGuideNumber.HyperLink = Nothing
			Me.lblGuideNumber.Left = 6.59F
			...
			Me.lblGuideNumber.Top = 0.1995F
			Me.lblGuideNumber.Width = 1.285F
			Me.Line1.Height = 0F
			Me.Line1.Left = 1.098F
			Me.Line1.LineWeight = 1F
			Me.Line1.Name = "Line1"
			Me.Line1.Top = 0.4095F
			Me.Line1.Visible = False
			Me.Line1.Width = 1.344F
			Me.Line1.X1 = 1.098F
			Me.Line1.X2 = 2.442F
			Me.Line1.Y1 = 0.4095F
			Me.Line1.Y2 = 0.4095F
			Me.Line2.Height = 0F
			Me.Line2.Left = 3.682F
			Me.Line2.LineWeight = 1F
			Me.Line2.Name = "Line2"
			Me.Line2.Top = 0.4095F
			Me.Line2.Visible = False
			Me.Line2.Width = 1.708F
			Me.Line2.X1 = 3.682F
			Me.Line2.X2 = 5.39F
			Me.Line2.Y1 = 0.4095F
			Me.Line2.Y2 = 0.4095F
			Me.Line3.Height = 0F
			Me.Line3.Left = 5.453001F
			Me.Line3.LineWeight = 1F
			Me.Line3.Name = "Line3"
			Me.Line3.Top = 0.4095F
			Me.Line3.Visible = False
			Me.Line3.Width = 1.082F
			Me.Line3.X1 = 5.453001F
			Me.Line3.X2 = 6.535F
			Me.Line3.Y1 = 0.4095F
			Me.Line3.Y2 = 0.4095F
			Me.Line4.Height = 0F
			...
			Me.Line4.Name = "Line4"
			Me.Line4.Top = 0.4095F
			Me.Line4.Visible = False
			Me.Line4.Width = 1.285F
			Me.Line4.X1 = 6.59F
			Me.Line4.X2 = 7.875F
			Me.Line4.Y1 = 0.4095F
			Me.Line4.Y2 = 0.4095F
			...
			Me.lblRodDiameter.Top = 0.0115F
			Me.lblRodDiameter.Width = 1.125F
			Me.Line5.Height = 0F
			Me.Line5.Left = 2.49F
			Me.Line5.LineWeight = 1F
			Me.Line5.Name = "Line5"
			Me.Line5.Top = 0.4095F
			Me.Line5.Visible = False
			Me.Line5.Width = 1.125F
			Me.Line5.X1 = 2.49F
			Me.Line5.X2 = 3.615F
			Me.Line5.Y1 = 0.4095F
			Me.Line5.Y2 = 0.4095F
			...
			Me.lblRodDiamUnits.Top = 0.1995F
			Me.lblRodDiamUnits.Width = 1.125F
			Me.lblGuideType.Height = 0.1875F
			Me.lblGuideType.HyperLink = Nothing
			Me.lblGuideType.Left = 5.453001F
			Me.lblGuideType.Name = "lblGuideType"
			Me.lblGuideType.Style = "background-color: rgb(192,192,192); color: rgb(255,255,255); text-align: center"
			Me.lblGuideType.Text = "Guide Type"
			Me.lblGuideType.Top = 0.012F
			Me.lblGuideType.Width = 1.082F
			Me.GroupFooter1.Height = 0F
			Me.GroupFooter1.Name = "GroupFooter1"
			Me.lblTaper.Height = 0.1875F
			Me.lblTaper.HyperLink = Nothing
			Me.lblTaper.Left = 0.125F
			...
			CType(Me.lblGuides, ISupportInitialize).EndInit()
			...
			CType(Me.lblGuideType, ISupportInitialize).EndInit()
		...
		Private Sub ActiveReport_ReportStart(sender As Object, e As EventArgs)
			...
			num2 = 0.2F
			RSWIN_DESC.SETUP_BAREROD_FRICCOEFF = Conversions.ToSingle(RSWIN.GetRegProfileStringBySingle(RSWIN_DESC.SECT_RSWIN, text, num2))
			...
			End If
			Dim num4 As Single = 37.5F
			If RSWIN_DESC.SETUP_MeasurementSystem <> 1 Then
				CtrlUI.ConvertValue(num4, "f", False)
			End If
			...
			If RSWIN_DESC.bIntVersion Then
				If RSWIN_DESC.bWriteResXFile Then
					Util.OpenResourceWriter("rptRecommendedGuideReport")
		...
		Private Sub ReadReportControlStrings()
			Dim sPrefix As String = "rptRecommendedGuideReport-" + RSWIN_DESC.SETUP_Language.Trim() + "-"
			Try
				Dim num As Integer = 0
		...
		Private lblGuides As DataDynamics.ActiveReports.Label
		...
		Private lblGuideType2 As DataDynamics.ActiveReports.Label
		...
		Private fldGuideType As DataDynamics.ActiveReports.TextBox
		...
		<AccessedThroughProperty("lblGuideType")>
		Private _lblGuideType As DataDynamics.ActiveReports.Label
